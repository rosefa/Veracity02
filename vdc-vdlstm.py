...
from keras.layers import GlobalAveragePooling1D,GlobalMaxPooling1D,Flatten,Concatenate, Dropout, LSTM, Bidirectional,Conv1D,MaxPooling1D,Flatten,BatchNormalization,Activation
